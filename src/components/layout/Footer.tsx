        ...
        <div className="grid md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            <div className="mb-6">
              ...
              <p className="text-gray-600">Transforming sermons into global ministry through premium podcasting services.</p>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#podcast" className="text-gray-600 hover:text-primary transition-colors">Podcast</a></li>
              <li>
                <a 
